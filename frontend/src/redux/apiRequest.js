...
import { getUsersFailed, getUsersStart, getUsersSuccess, deleteUsersStart, deleteUsersSuccess, deleteUsersFailed } from "./userSlice";
...
export const registerUser = async (user, dispatch, navigate) => {
    ...
    try {
        const res = await axious.post("http://localhost:8000/v1/auth/register", user);
